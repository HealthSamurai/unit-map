...
(use-fixtures
  :each
  (fn [t]
    (defmethod ops/definition :default-type [_] sut/calendar)
    (t)))

#_(deftest days-and-months
...
(deftest comparsion-operators-test
  ...
  (testing "= with utc-offset"
    (is (sut/eq? {:hour 10 :min 10 :tz 0} {:hour 13 :min 10 :tz 3}))
    (is (not (sut/eq? {:hour 13 :min 10 :tz 0} {:hour 13 :min 10 :tz 3})))
    (is (sut/eq? {:hour 210 :min 10 :tz 0} {:hour 213 :min 10 :tz 3}))
    (is (sut/eq? {:hour 15 :min 10 :tz 0} {:hour 13 :min 10 :tz -2}))
    (is (sut/eq? {:hour 12 :min 10 :tz 2} {:hour 13 :min 10 :tz 3}))
    (is (sut/eq? {:hour 10 :min 10 :tz 0} {:hour 12 :min 10 :tz 2}))
    (is (sut/eq? {:hour 12 :min 10} {:hour 12 :min 10 :tz 2})))
  (testing "not="
  ...
  (testing "not= with utc-offset"
    (is (not (sut/not-eq? {:hour 10 :min 10 :tz 0} {:hour 13 :min 10 :tz 3})))
    (is (sut/not-eq? {:hour 13 :min 10 :tz 0} {:hour 13 :min 10 :tz 3}))
    (is (not (sut/not-eq? {:hour 210 :min 10 :tz 0} {:hour 213 :min 10 :tz 3})))
    (is (not (sut/not-eq? {:hour 15 :min 10 :tz 0} {:hour 13 :min 10 :tz -2})))
    (is (not (sut/not-eq? {:hour 12 :min 10 :tz 2} {:hour 13 :min 10 :tz 3})))
    (is (not (sut/not-eq? {:hour 10 :min 10 :tz 0} {:hour 12 :min 10 :tz 2}))))
  (testing ">"
    ...
    (is (sut/gt {:year 2011 :month 1 :day 2 :hour 0}
                ...
                {:year 2011 :month 1 :day 1 :hour 0})))
  (testing "> with utc-offset"
    (is (sut/gt {:hour 13 :tz 0} {:hour 13 :tz 3}))
    (is (not (sut/gt {:hour 13 :tz 3} {:hour 13 :tz 0})))
    (is (sut/gt {:hour 13 :tz -3} {:hour 13 :tz 0}))
    (is (not (sut/gt {:hour 13 :tz 0} {:hour 13 :tz -3})))
    (is (sut/gt {:hour 13 :tz -3} {:hour 13 :tz -2}))
    (is (not (sut/gt {:hour 13 :tz -2} {:hour 13 :tz -3})))
    (is (not (sut/gt {:hour 10 :min 10 :tz 0} {:hour 13 :min 10 :tz 3}))))
  (testing "<"
    ...
    (is (sut/lt {:year 2011 :month 1 :day 1 :hour 0}
                ...
                {:year 2011 :month 1 :day 2 :hour 0})))
  (testing "< with utc-offset"
    (is (sut/lt {:hour 13 :tz 3} {:hour 13 :tz 0}))
    (is (not (sut/lt {:hour 13 :tz 0} {:hour 13 :tz 3})))
    (is (sut/lt {:hour 13 :tz 0} {:hour 13 :tz -3}))
    (is (not (sut/lt {:hour 13 :tz -3} {:hour 13 :tz 0})))
    (is (sut/lt {:hour 13 :tz -2} {:hour 13 :tz -3}))
    (is (not (sut/lt {:hour 13 :tz -3} {:hour 13 :tz -2})))
    (is (not (sut/lt {:hour 13 :min 10 :tz 3} {:hour 10 :min 10 :tz 0}))))
  (testing "<="
...
(deftest arithmetic-operations-test
  (testing "+"
    ...
    (is (= (sut/plus {:year 2011 :month 1 :day 1 :hour 0} (sut/to-new-fmt {:hour -1}))
    ...
    (is (= (sut/plus {:year 2019 :month 11 :day 31} {:month 1})
           {:year 2020 :month 1 :day 1}))
    ...
    #_(is (sut/eq? {:hour 0, :day 1, :tz -2}
                 (sut/plus {:day 1 :hour 23 :tz -2} ^:delta{:hour 1})))

    (is (= (sut/plus {:hour 1 :tz -2} {:hour 1})
           {:hour 2 :tz -2}))

    #_(testing "with custom units"
  ...
  (testing "-"
    (is (= (sut/minus {:year 2016, :month 12, :day 31, :hour 23, :min 30} ^:delta{:day 365})
           {:year 2016, :month 1, :day 1, :hour 23, :min 30}))

    (is (= (sut/minus {:year 2016 :month 12 :day 31 :hour 23 :min 30} ^:delta{:day 366})
    ...
    (is (sut/eq? {:hour 0, :tz -2}
                 (sut/minus {:hour 2 :tz -2} ^:delta{:hour 2})))
    (is (sut/eq? ^:delta{:hour 0}
                 (sut/minus {:hour 2 :tz -2} {:hour 2})))
    (is (sut/eq? ^:delta{:hour 2}
                 (sut/minus {:hour 3 :tz 2} {:hour 1 :tz 2})))))
...
(deftest tz-operations-test
  ...
  (testing "to-tz"
    ...
    (is (= (sut/to-tz {:day 2 :hour 1 :tz 0} -2)
           {:day 1 :hour 23 :tz -2}))
    (is (= (sut/to-tz {:day 1 :hour 1} -2)
           {:day 1 :hour 1 :tz -2}))

    (is (sut/eq? (sut/to-tz {:hour 1 :tz 0} -1)
                 {:hour 0, :tz -1}))
    (is (= (sut/to-tz {:hour 1} -1)
           {:hour 1 :tz -1}))))

#_(deftest test-timezones
