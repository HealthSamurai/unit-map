...
(do ;;NOTE: seqs
  ...
  (sut/defseq ::ampm-hour   #unit-map/seq[::hour <=> 12 1 2 .. 11 -> ::ampm-period])
  (sut/defseq ::ampm-period #unit-map/seq[:am :pm -> ::day])
  ...
  (t/testing "inc-unit"
    (t/testing "am-pm clock"
      ...
      (t/is (= [{::ampm-hour 12, ::ampm-period :am} {::ampm-hour 1, ::ampm-period :am} {::ampm-hour 2, ::ampm-period :am}
               ...
               (take 24 (iterate (partial sut/inc-unit ::ampm-hour) value)))))
  ...
  (t/testing "dec-unit"
    (t/testing "am-pm clock"
      ...
      (t/is (= [{::ampm-hour 11, ::ampm-period :pm} {::ampm-hour 10, ::ampm-period :pm} {::ampm-hour 9, ::ampm-period :pm}
               ...
               (take 24 (iterate (partial sut/dec-unit ::ampm-hour) value)))))
